...
public class AnalyseMut_expr_rest{
    ...
    public AnalyseMut_expr_rest(ArrayList<String[]> token_stack){
    ...
    public void Analyse(){
        ...
        if (validetoken2.contains(currentToken)){
            AnalyseBinop_mut R1 = new AnalyseBinop_mut(this.token_stack);
            R1.Analyse();
            AnalyseMut_expr R2 = new AnalyseMut_expr(this.token_stack);
            R2.Analyse();
        }
