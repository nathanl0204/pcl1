...
public class AnalyseComp_expr_rest{
    ...
    public AnalyseComp_expr_rest(ArrayList<String[]> token_stack){
    ...
    public void Analyse(){
        ...
        if (validetoken2.contains(currentToken)){
            AnalyseBinop_comp R1 = new AnalyseBinop_comp(this.token_stack);
            R1.Analyse();
